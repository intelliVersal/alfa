...
class VatReturnPayment(models.TransientModel):

    _name = "vat.return.payment"
    _description = "Vat Return Payment"

    @api.model
    def _default_partner_id(self):
        context = dict(self._context or {})
        active_ids = context.get('active_ids', [])
        vat_returns = self.env['uae.vat.return'].browse(active_ids)
