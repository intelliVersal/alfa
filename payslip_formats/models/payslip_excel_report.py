...
class BankTemplateReport(models.Model):
    ...
    def generate_xls_report(self):
        ...
        ws1.write(0, 1, 'اسم العميل', sub_header_style)
        ws1.write(0, 2, 'رمز الإتفاقية', sub_header_style)
        ws1.write(0, 3, 'حساب التمويل', sub_header_style)
        ws1.write(0, 4, 'رقم الفرع', sub_header_style)
        ws1.write(0, 5, 'تاريخ الإستحقاق', sub_header_style)
        ws1.write(0, 6, 'رقم  المنشأه في مكتب العمل', sub_header_style)
        ws1.write(0, 7, 'رقم المنشأه في الغرفة التجارية', sub_header_style)
        ws1.write(0, 8, 'رمز البنك', sub_header_style)
        ws1.write(0, 9, 'العملة', sub_header_style)
        ws1.write(0, 10, 'رقم الدفعة', sub_header_style)
        ws1.write(0, 11, 'مرجع الملف', sub_header_style)
        ws1.write(0, 12, '', sub_header_style)
        ws1.write(0, 13, '', sub_header_style)
        ws1.write(1, 14, '', sub_header_style)

        ws1.write(1, 0, '111', sub_header_style)
        ws1.write(1, 1, 'PAY34077', sub_header_style)
        ws1.write(1, 2, 'PAY34077', sub_header_style)
        ws1.write(1, 3, '2123706259941', sub_header_style)
        ws1.write(1, 4, '212', sub_header_style)
        ws1.write(1, 5, str(fields.Date.today()), sub_header_style)
        ws1.write(1, 6, '1-171109', sub_header_style)
        ws1.write(1, 7, '7004337262', sub_header_style)
        ws1.write(1, 8, 'RIBL', sub_header_style)
        ws1.write(1, 9, 'SAR', sub_header_style)
        ws1.write(1, 10, '', sub_header_style)
        ws1.write(1, 11, '', sub_header_style)
        ws1.write(1, 12, '', sub_header_style)
        ws1.write(1, 13, '', sub_header_style)
        ws1.write(1, 14, '', sub_header_style)

        ws1.write(2, 0, 'SN', sub_header_style)
        ws1.write(2, 1, 'هوية المستفيد/ المرجع', sub_header_style)
        ws1.write(2, 2, 'المستفيد / اسم الموظف', sub_header_style)
        ws1.write(2, 3, 'رقم الحساب ', sub_header_style)
        ws1.write(2, 4, 'رمز البنك', sub_header_style)
        ws1.write(2, 5, 'إجمالي المبلغ', sub_header_style)
        ws1.write(2, 6, 'الراتب الأساسي', sub_header_style)
        ws1.write(2, 7, 'بدل السكن', sub_header_style)
        ws1.write(2, 8, 'دخل آخر', sub_header_style)
        ws1.write(2, 9, 'الخصومات', sub_header_style)
        ws1.write(2, 10, 'العنوان', sub_header_style)
        ws1.write(2, 11, 'العملة', sub_header_style)
        ws1.write(2, 12, 'الحالة', sub_header_style)
        ws1.write(2, 13, 'وصف الدفع', sub_header_style)
        ws1.write(2, 14, 'مرجع الدفع', sub_header_style)
